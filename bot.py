...
import telebot
TOKEN = '5723428457:AAFKRHk6brB3zaRSyAehBBbcuBQZH9I7qo4'
...
def lalala(message):
	if message.chat.type == 'private':
		if message.text == '🧡 Мой репозиторий':
			bot.send_message(message.chat.id, 'https://github.com/MuliukovaAigul')
		elif message.text == '😋 Написать мне в личку':
			bot.send_message(message.chat.id, 'https://t.me/MulyukovaAigul')
		else:
